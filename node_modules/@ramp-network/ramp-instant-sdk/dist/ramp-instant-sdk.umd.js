(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function normalizeConfigAndLogErrorsOnInvalidFields(config) {
        ...
        if (!['desktop', 'mobile', 'hosted-desktop', 'hosted-mobile', 'hosted-auto', 'auto'].includes(config.variant)) {
    ...
    var RampInstantSDK = /** @class */ (function () {
        function RampInstantSDK(config) {
            ...
            this._config = __assign(__assign({}, temporaryConfig), { variant: widgetVariant, widgetInstanceId: getRandomIntString() });
        }
