...
export declare type TransactionEventCode = 'txSent' | 'txPool' | 'txConfirmed' | 'txSpeedUp' | 'txCancel' | 'txFailed' | 'txRequest' | 'nsfFail' | 'txRepeat' | 'txAwaitingApproval' | 'txConfirmReminder' | 'txSendFail' | 'txError' | 'txUnderPriced' | 'all';
export interface Ac {
    address: string;
    emitters: Emitter[];
}
