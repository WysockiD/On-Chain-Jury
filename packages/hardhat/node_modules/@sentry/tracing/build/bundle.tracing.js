    ...
    ***************************************************************************** */
    ...
    var MetricsInstrumentation = /** @class */ (function () {
        function MetricsInstrumentation() {
            ...
            if (global$6 && global$6.performance) {
                if (global$6.performance.mark) {
                    global$6.performance.mark('sentry-tracing-init');
                }
                this._trackCLS();
                this._trackLCP();
                this._trackFID();
        ...
        MetricsInstrumentation.prototype.addPerformanceEntries = function (transaction) {
            var _this = this;
            if (!global$6 || !global$6.performance || !global$6.performance.getEntries || !browserPerformanceTimeOrigin) {
    ...
    function defaultRoutingInstrumentation(startTransaction, startTransactionOnPageLoad, startTransactionOnLocationChange) {
        ...
        if (!global$7 || !global$7.location) {
            logger.warn('Could not initialize routing instrumentation due to invalid location');
            return;
        }
        var startingUrl = global$7.location.href;
        var activeTransaction;
        if (startTransactionOnPageLoad) {
            activeTransaction = startTransaction({ name: global$7.location.pathname, op: 'pageload' });
        }
            ...
            addInstrumentationHandler({
                callback: function (_a) {
                    ...
                    if (from !== to) {
                        ...
                        activeTransaction = startTransaction({ name: global$7.location.pathname, op: 'navigation' });
                    }
                },
                type: 'history',
            });
