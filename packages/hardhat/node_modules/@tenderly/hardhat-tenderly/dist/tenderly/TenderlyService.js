...
exports.TenderlyService = exports.TENDERLY_DASHBOARD_BASE_URL = exports.TENDERLY_API_BASE_URL = void 0;
...
class TenderlyService {
    static async verifyContracts(request) {
        ...
        try {
            ...
            if (!((_a = responseData.contracts) === null || _a === void 0 ? void 0 : _a.length)) {
                console.log(`${index_1.PluginName}: No new contracts have been verified`);
                return;
            }
    ...
    static async pushContracts(request, tenderlyProject, username) {
        ...
        try {
            ...
            const responseData = response.data;
            if (responseData.bytecode_mismatch_errors != null) {
                console.log(`Error in ${index_1.PluginName}: Bytecode mismatch detected. Contract push failed`);
                return;
            }
            if (!((_a = responseData.contracts) === null || _a === void 0 ? void 0 : _a.length)) {
                console.log(`${index_1.PluginName}: No new contracts have been pushed`);
                return;
            }
